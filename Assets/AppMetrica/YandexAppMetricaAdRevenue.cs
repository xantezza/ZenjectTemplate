...
///         <see cref="IYandexAppMetrica.ReportAdRevenue(YandexAppMetricaAdRevenue)" /> method.
///     </para>
/// </summary>
[Serializable]
public struct YandexAppMetricaAdRevenue
{
    ...
    /// </summary>
    /// <param name="adRevenueMicros">
    ///     Amount of money received via ad revenue represented as micros
    ...
    ///     Creates the new instance of YandexAppMetricaAdRevenue.
    /// </summary>
    /// <param name="adRevenue">
    ///     Amount of money received via ad revenue represented as double.
    ///     It will be converted to decimal.
    /// </param>
    /// <param name="currency">Currency.</param>
