...
public class YandexAppMetricaErrorDetails
{
    ...
    [NotNull] public string Platform { get; }

    [NotNull] public string VirtualMachineVersion { get; }
        ...
        [CanBeNull] string stacktraceFromLog)
    {
        ...
        var exceptionClass = conditionParts.Length == 2 ? conditionParts[0].Trim() : "Exception";
        var message = (conditionParts.Length == 2 ? conditionParts[1] : conditionParts[0]).Trim();

        var stacktrace = stacktraceFromLog != null
