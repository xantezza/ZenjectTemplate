...
namespace UniRx
{
        ...
        where TValue : IDisposable
    {
        ...
        public Dictionary<TKey, TValue>.KeyCollection Keys => throw new NotSupportedException("please use .Select(x => x.Key).ToArray()");

        public Dictionary<TKey, TValue>.ValueCollection Values => throw new NotSupportedException("please use .Select(x => x.Value).ToArray()");
