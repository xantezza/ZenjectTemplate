...
namespace UniRx
{
    public static class UnityEventExtensions
    {
        ...
        {
            return Observable.FromEvent(h => new UnityAction(h), h => unityEvent.AddListener(h), h => unityEvent.RemoveListener(h));
        }
        ...
        {
            return Observable.FromEvent<UnityAction<T0, T1>, Tuple<T0, T1>>(h => { return (t0, t1) => { h(Tuple.Create(t0, t1)); }; }, h => unityEvent.AddListener(h),
        ...
        {
            return Observable.FromEvent<UnityAction<T0, T1, T2>, Tuple<T0, T1, T2>>(h => { return (t0, t1, t2) => { h(Tuple.Create(t0, t1, t2)); }; }, h => unityEvent.AddListener(h),
                h => unityEvent.RemoveListener(h));
        }

        public static IObservable<Tuple<T0, T1, T2, T3>> AsObservable<T0, T1, T2, T3>(this UnityEvent<T0, T1, T2, T3> unityEvent)
        {
            return Observable.FromEvent<UnityAction<T0, T1, T2, T3>, Tuple<T0, T1, T2, T3>>(h => { return (t0, t1, t2, t3) => { h(Tuple.Create(t0, t1, t2, t3)); }; }, h => unityEvent.AddListener(h),
                h => unityEvent.RemoveListener(h));
        }
    }
}
