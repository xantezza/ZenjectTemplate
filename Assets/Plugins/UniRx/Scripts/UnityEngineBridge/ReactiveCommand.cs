...
namespace UniRx
{
    ...
    {
        private readonly Subject<T> trigger = new();
    ...
    public static class ReactiveCommandExtensions
    {
        ...
        public static Task<T> WaitUntilExecuteAsync<T>(this IReactiveCommand<T> source, CancellationToken cancellationToken = default)
        {
    ...
    public static class AsyncReactiveCommandExtensions
    {
        ...
        public static Task<T> WaitUntilExecuteAsync<T>(this IAsyncReactiveCommand<T> source, CancellationToken cancellationToken = default)
        {
            var tcs = new CancellableTaskCompletionSource<T>();
