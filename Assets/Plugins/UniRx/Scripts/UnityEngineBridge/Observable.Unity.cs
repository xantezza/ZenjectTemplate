...
#pragma warning restore CS0618
        ...
        {
            return FromCoroutine<T>((observer, cancellationToken) => WrapEnumeratorYieldValue(coroutine(), observer, cancellationToken, nullAsNextUpdate));
        }

        /// <summary>Convert coroutine to typed IObservable. If nullAsNextUpdate = true then yield return null when Enumerator.Current and no null publish observer.OnNext.</summary>
        public static IObservable<T> FromCoroutineValue<T>(Func<CancellationToken, IEnumerator> coroutine, bool nullAsNextUpdate = true)
        {
            return FromCoroutine<T>((observer, cancellationToken) => WrapEnumeratorYieldValue(coroutine(cancellationToken), observer, cancellationToken, nullAsNextUpdate));
        }
        ...
        {
            return new Operators.FromCoroutineObservable<T>(coroutine);
        }
        ...
        {
            return new Operators.FromMicroCoroutineObservable<T>(coroutine, frameCountType);
        }
        ...
        {
            return FromMicroCoroutine<long>((observer, cancellationToken) => EveryCycleCore(observer, cancellationToken));
        }
        ...
        public static IObservable<T> DelayFrame<T>(this IObservable<T> source, int frameCount, FrameCountType frameCountType = FrameCountType.Update)
        {
            ...
            return new Operators.DelayFrameObservable<T>(source, frameCount, frameCountType);
        }

        public static IObservable<T> Sample<T, T2>(this IObservable<T> source, IObservable<T2> sampler)
        {
            return new Operators.SampleObservable<T, T2>(source, sampler);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new Operators.SampleFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new Operators.ThrottleFrameObservable<TSource>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new Operators.ThrottleFirstFrameObservable<TSource>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new Operators.TimeoutFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentOutOfRangeException("frameCount");
            return new Operators.DelayFrameSubscriptionObservable<T>(source, frameCount, frameCountType);
        }
        ...
        public static IEnumerator ToAwaitableEnumerator<T>(this IObservable<T> source, CancellationToken cancel = default)
        {
            return ToAwaitableEnumerator(source, Stubs<T>.Ignore, Stubs.Throw, cancel);
        }

        /// <summary>Convert to awaitable IEnumerator.</summary>
        public static IEnumerator ToAwaitableEnumerator<T>(this IObservable<T> source, Action<T> onResult, CancellationToken cancel = default)
        {
            return ToAwaitableEnumerator(source, onResult, Stubs.Throw, cancel);
        }

        /// <summary>Convert to awaitable IEnumerator.</summary>
        public static IEnumerator ToAwaitableEnumerator<T>(this IObservable<T> source, Action<Exception> onError, CancellationToken cancel = default)
        {
            return ToAwaitableEnumerator(source, Stubs<T>.Ignore, onError, cancel);
        }

        /// <summary>Convert to awaitable IEnumerator.</summary>
        public static IEnumerator ToAwaitableEnumerator<T>(this IObservable<T> source, Action<T> onResult, Action<Exception> onError, CancellationToken cancel = default)
        {
        ...
        /// <summary>AutoStart observable as coroutine.</summary>
        public static Coroutine StartAsCoroutine<T>(this IObservable<T> source, Action<T> onResult, CancellationToken cancel = default)
        {
            return StartAsCoroutine(source, onResult, Stubs.Throw, cancel);
        }

        /// <summary>AutoStart observable as coroutine.</summary>
        public static Coroutine StartAsCoroutine<T>(this IObservable<T> source, Action<Exception> onError, CancellationToken cancel = default)
        {
            return StartAsCoroutine(source, Stubs<T>.Ignore, onError, cancel);
        }

        /// <summary>AutoStart observable as coroutine.</summary>
        public static Coroutine StartAsCoroutine<T>(this IObservable<T> source, Action<T> onResult, Action<Exception> onError, CancellationToken cancel = default)
        {
        ...
        {
            return new Operators.RepeatUntilObservable<T>(sources, trigger, lifeTimeChecker);
        }

        public static IObservable<FrameInterval<T>> FrameInterval<T>(this IObservable<T> source)
        {
            return new Operators.FrameIntervalObservable<T>(source);
        }

        public static IObservable<TimeInterval<T>> FrameTimeInterval<T>(this IObservable<T> source, bool ignoreTimeScale = false)
        {
            return new Operators.FrameTimeIntervalObservable<T>(source, ignoreTimeScale);
        }
        ...
        public static IObservable<IList<T>> BatchFrame<T>(this IObservable<T> source, int frameCount, FrameCountType frameCountType)
        {
            ...
            return new Operators.BatchFrameObservable<T>(source, frameCount, frameCountType);
        }
        ...
        {
            if (frameCount < 0) throw new ArgumentException("frameCount must be >= 0, frameCount:" + frameCount);
            return new Operators.BatchFrameObservable(source, frameCount, frameCountType);
        }
